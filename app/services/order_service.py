...
class OrderService:
    ...
    async def create_order(
        ...
        # Accounting is handled by event handlers:
        #   ORDER_CONFIRMED → COGS journal (via accounting_engine)
        #   PAYMENT_COMPLETED → revenue journal (via accounting_engine)
        # No direct accounting call here — avoids duplicate entries.
